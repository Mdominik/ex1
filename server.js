...
app.get('/api', (req, res) => {
  ...
  res.json({
    ...
    endpoints: [
      ...
      {method: 'PUT', path: '/api/books/:id', description: 'Update a book information'},
      {method: 'DELETE', path: '/api/books/:id', description: 'Delete a book information'},
...
app.get('/api/profile', (req, res) => {
  res.json({
    'name': 'Dominik',
    'homeCountry': 'PL',
    'degreeProgram': 'MSEI',//informatics or CSE.. etc
    'email': 'ge23ji@mytum.de',
...
app.post('/api/books/', (req, res) => {
   ...
   */
  var newBook = BooksModel(req.body);
  newBook.save();
  res.json(newBook);
});
...
app.put('/api/books/:id', (req, res) => {
  ...
  const book = db.books.findByIdAndUpdate(bookId, bookNewData).exec();
  /*
...
app.delete('/api/books/:id', (req, res) => {
   ...
   */
  const bookId = req.params.id;
  const book = db.books.findByIdAndDelete(bookId).exec();
  /*
